...
public class FoodCategoryActivity extends Activity {
    ...
    private void initViews() {
        try {
            ...
            tvGaiMa = (TextView) findViewById(R.id.ok);
...
{
	Intent intent=new Intent(FoodCategoryActivity.this,OrderExpand.class);
	//intent.putExtra("PreviousClass", "FoodCategoryActivity");
    startActivity(intent);
}
